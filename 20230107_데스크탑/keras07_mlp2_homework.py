...
print(x.shape)                                      # (3, 10) 에서 전치하니 (10, 3)로 출력된다.

model=Sequential()                                  # 모델은 순차적으로 구성하겠다.
model.add(Dense(3, input_dim=3))                    # 3열이라서 iuput_dim은 3
model.add(Dense(55))                                
...
print("[[10, 1.4, 0]]의 예측 결과 : ", result)

'''
[[10, 1.4, 0]]의 결과(1트): 20.044224,  loss값: 0.026196647435426712
[[10, 1.4, 0]]의 결과(2트): 20.202406,  loss값: 0.11597971618175507
[[10, 1.4, 0]]의 결과(3트): 19.602898,  loss값: 0.21899911761283875
[[10, 1.4, 0]]의 결과(4트): 20.117746,  loss값: 0.057779788970947266
[[10, 1.4, 0]]의 결과(5트): 20.199045,  loss값: 0.19365426898002625
