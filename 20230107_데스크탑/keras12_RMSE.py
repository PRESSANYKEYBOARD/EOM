...
from sklearn.metrics import mean_squared_error                                      # RMSE 함수는 아직 없어서 직접 만들어 사용. - 회귀 분석 모델 / 사이킷런에서도 rmse는 제공하지 않음. / MSE 함수 불러옴.
...
'''
RMSE(1트): 3.8159789648842892
RMSE(2트): 3.7999880747302957
RMSE(3트): 3.8066744821335914
RMSE(4트): 3.813995404709394
RMSE(5트): 3.8039894370533287
