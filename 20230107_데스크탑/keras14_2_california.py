...
model.fit(x_train, y_train, epochs=3200, batch_size=100)                            # epoch: 훈련을 여러번 시키는것. fit: 훈련시킴. / epoch 너무 많이하면 오히려 성능이 떨어지는 경우가 있기 때문에, 적절한 epoch 수치를 찾아내야 함. / 이번엔 훈련 수치를 3200번으로 조정.
...
1트 RMSE: 0.7361024861728455,    R2: 0.5902205692722327
