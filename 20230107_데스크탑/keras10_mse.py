...
#3. 컴파일, 훈련
model.compile(loss='mae', optimizer='adam')                 # MSE는 추정된 값과 실제 값 간의 평균 제곱 차이를 의미한다. #주로 회귀에서 사용되는 손실 함수이며, 정확도 개념은 회귀에 적용되지 않는다고 한다.
...
'''
mae(1트): 3.110147476196289,  mse(1트): 14.545794486999512
mae(2트): 3.1267082691192627, mse(2트): 14.502484321594238
mae(3트): 3.14624285697937,   mse(3트): 14.543133735656738
mae(4트): 3.0838587284088135, mse(4트): 14.451830863952637
mae(5트): 3.1340715885162354, mse(5트): 14.57846450805664
