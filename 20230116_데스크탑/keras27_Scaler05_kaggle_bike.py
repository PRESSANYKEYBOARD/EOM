...
submission.to_csv(path + 'submission_01162013.csv')


'''

CPU 결과(minmax)
RMSE : 147.35965756304873
R2 :  0.3194033616223383

GPU 결과(minmax)
RMSE : 145.90781734964725
R2 :  0.3327482613129308

CPU 결과(stand)
RMSE : 147.0295362515433
R2 :  0.32244934843297357

GPU 결과(stand)
RMSE : 146.39108491216257
R2 :  0.32832087495506834
