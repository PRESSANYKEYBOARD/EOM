...
model.add(Dense(48, activation="relu", input_dim=10))                               # 13열이라서 iuput_dim은 13       # x열의 개수      # relu: 0 이하의 값은 다음 레이어에 전달하지 않습니다. 0 이상의 값은 그대로 출력합니다.
...
CPU 결과(minmax)
RMSE : 54.71375856481843
R2 :  0.4965963301012639

GPU 결과(minmax)
RMSE : 54.40457787328089
R2 :  0.5022695991301557

CPU 결과(stand)
RMSE : 55.145630430737384
R2 :  0.48861793810648757

GPU 결과(stand)
RMSE : 54.80483712142955
R2 :  0.4949189662330703
