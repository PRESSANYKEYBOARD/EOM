...
model.add(Dense(16, input_dim=10, activation='relu'))                               # 10열이라서 iuput_dim은 10      # x열의 개수      # relu: 0 이하의 값은 다음 레이어에 전달하지 않습니다. 0 이상의 값은 그대로 출력합니다.
...
#2. 모델구성
model = Sequential()                                                                # 모델은 순차적으로 구성하겠다.
model.add(Dense(16, input_dim=8, activation='relu'))                                # 8열이라서 iuput_dim은 13       # x열의 개수      # relu: 0 이하의 값은 다음 레이어에 전달하지 않습니다. 0 이상의 값은 그대로 출력합니다.
model.add(Dense(32, activation='relu'))
model.add(Dense(16, activation='relu'))
model.add(Dense(15, activation='relu'))
model.add(Dense(14, activation='relu'))
...
CPU 결과
RMSE: 51.758058025319336,   R2: 0.5982992956295107,        val_loss: 4879.6812 

GPU 결과
RMSE: 52.03049692368499,    R2: 0.5940593017685126,        val_loss: 4502.4780
