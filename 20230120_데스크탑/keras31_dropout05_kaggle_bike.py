...
model.save(path+'keras31_dropout05_save_model.h5')                      # 가중치 및 모델 세이브
...
submission.to_csv(path + 'submission_01201855.csv')         # 날짜.시간 01061152 = 1월 6일 11시 52분

"""
CPU
r2스코어: 0.33344361034079484

GPU
r2스코어: 0.34812321564866556
