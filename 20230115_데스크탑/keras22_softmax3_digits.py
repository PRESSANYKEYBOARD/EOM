...
#1. 데이터
datasets = load_digits()                                        # load_digits 불러오기
...
#2. 모델구성
model = Sequential()
model.add(Dense(50, activation='relu', input_shape=(64, )))      # 모델을 늘리는 것도 성능에 큰 차이를 줌                     
...
"""
CPU ACC: 0.9777777777777777
GPU ACC: 0.9722222222222222
