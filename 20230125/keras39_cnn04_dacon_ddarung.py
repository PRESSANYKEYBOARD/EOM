...
# print(x_train.shape, x_test.shape)                            # (1062, 9, 1, 1) (266, 9, 1, 1)
...
submission.to_csv(path + 'submission_01251721.csv')         # 날짜.시간 01061152 = 1월 6일 11시 52분
