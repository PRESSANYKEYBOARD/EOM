...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath=path + 'MCP/keras31_ModelCheckPoint3.hdf5')
                      filepath = filepath + 'k39_04' + date + '_' + filename
)
...
model.save(path+'keras39_dropout04_save_model.h5')                      # 가중치 및 모델 세이브
...
submission.to_csv(path + 'submission_01291456.csv')         # 날짜.시간 01061152 = 1월 6일 11시 52분
