...
model.add(Conv1D(100, 2, input_shape=(9, 1)))   # 연산량 300
model.add(Flatten())
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath=path + 'MCP/keras31_ModelCheckPoint3.hdf5')
                      filepath = filepath + 'k51_04' + date + '_' + filename
)
...
model.save(path+'keras51_Conv1D04_save_model.h5')                      # 가중치 및 모델 세이브
...
submission.to_csv(path + 'submission_01292051.csv')         # 날짜.시간 01061152 = 1월 6일 11시 52분
