...
model.add(Conv1D(100, 2, input_shape=(54, 1)))   # 연산량 300
model.add(Flatten())
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath=path + 'MCP/keras31_ModelCheckPoint3.hdf5')
                      filepath = filepath + 'k51_10' + date + '_' + filename
)
...
model.save(path+'keras51_Conv1D10_save_model.h5')                      # 가중치 및 모델 세이브
...
lstm
r2스코어: 0.9450777881695311

Conv1D
r2스코어: 0.7773401651713262
