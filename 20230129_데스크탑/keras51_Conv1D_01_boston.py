...
model.add(Conv1D(100, 2, input_shape=(13, 1)))   # 연산량 300
model.add(Flatten())
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath=path + 'MCP/keras31_ModelCheckPoint3.hdf5')
                      filepath = filepath + 'k51_01' + date + '_' + filename
)
...
model.save(path+'keras51_Conv1D01_save_model.h5')                      # 가중치 및 모델 세이브
...
lstm
r2스코어: 0.6996411466116774

Conv1D
r2스코어: 0.8339144377632954
