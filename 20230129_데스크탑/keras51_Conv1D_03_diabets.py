from tensorflow.keras.layers import Dense, SimpleRNN, LSTM, Dropout, Conv2D, Flatten, MaxPooling2D# 데스크탑에서 세팅하고 다시 복습용으로 생성했습니다. 블루스크린 나쁜 놈 ㅠㅠㅠ
...
model.add(Conv1D(100, 2, input_shape=(10, 1)))   # 연산량 300
model.add(Flatten())
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath=path + 'MCP/keras31_ModelCheckPoint3.hdf5')
                      filepath = filepath + 'k51_03' + date + '_' + filename
)
...
model.save(path+'keras51_Conv1D03_save_model.h5')                      # 가중치 및 모델 세이브
