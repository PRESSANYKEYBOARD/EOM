...
model.add(Dense(1, activation = 'linear'))                             # 노드의 총 갯수는 drop을 해도 모두 동일하다.
...
model.save(path+'keras39_dropout05_save_model.h5')                      # 가중치 및 모델 세이브
...
submission.to_csv(path + 'submission_01291457.csv')         # 날짜.시간 01061152 = 1월 6일 11시 52분
