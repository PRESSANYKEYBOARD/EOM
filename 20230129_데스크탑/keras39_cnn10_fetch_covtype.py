...
print(x_train.shape, x_test.shape)                                      # (464809, 9, 6, 1) (116203, 9, 6, 1)

#2. 모델구성
model = Sequential()
model.add(Conv2D(64, (2,1), input_shape=(9, 6, 1)))
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath=path + 'MCP/keras31_ModelCheckPoint3.hdf5')
                      filepath = filepath + 'k39_10' + date + '_' + filename
)
...
model.save(path+'keras39_dropout10_save_model.h5')                      # 가중치 및 모델 세이브
