...
submission.to_csv(path + 'submission_01171901.csv')


'''

CPU 결과(minmax)
RMSE : 46.11998377134166
R2 :  0.7070521923383299

GPU 결과(minmax)
RMSE : 46.29879393024334
R2 :  0.7047762336743462

CPU 결과(stand)
RMSE : 54.30226421796681
R2 :  0.5938861154807237

GPU 결과(stand)
RMSE : 52.76738445886347
R2 :  0.6165196665346149
